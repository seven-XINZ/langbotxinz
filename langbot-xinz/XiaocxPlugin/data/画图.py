...
def translate_baidu(text, from_lang='zh', to_lang='en'):
    ...
    try:
        ...
        return 'super fine illustration, vibrant colors, masterpiece, sharp focus, best quality, depth of field, cinematic lighting, ultra detailed, lora:more_details:0.5,(masterpiece, best quality:1.3), (absurdres absolutely resolution), (8k),  (detailed illustration), (super fine illustration), __PROMPT__,' + '\n'.join(translation) if translation else "未获取到翻译结果"
...
def main(prompt):
    ...
    # 设置API Token
    token = 'eyJhbGciOiJFUzUxMiIsInR5cCI6IkpXVCJ9.eyJsZ2EiOjE3MzgzNDE4MjEsImlhdCI6MTczODM0NDk2NSwiZXhwIjoxNzM4OTQ5NzY1LCJpc3MiOiJwaXhhaSIsInN1YiI6IjE2MTQ0NjczNzg0ODQ2ODE0MDEiLCJqdGkiOiIxODQyMTA2NDYwNjIxMjM3MDQxIn0.AEcFz5dS67zxtqDEOpNdx5VfbKp9IyXAuNuSQCWFAuM5GipJg7M0Uv1kUypBDKWBmaJBPqXw7VTieFNaVW7AZIEGAMgXOFYqRUHMwxe9OmHcgiv-FNW4_g_EH5L8i10DiWoH3-KqnEm_JxBZICeaW87o1VEd2uHqOOSIcEndQYZEYxFI'
